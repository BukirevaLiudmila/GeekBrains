...
var gameScoreField = document.getElementById('score-field');
...
function startGame() {
    ...
    // Отображение счета
    gameScoreField.innerText = score;
}
...
function haveFood(unit) {
    ...
    if (unit_classes.includes('food-unit')) {
        ...
        score++;
        gameScoreField.innerText = score; // отображение счета
    }
    return check;
}
